...
export class MainMenuScene extends Phaser.Scene {
  ...
  private createLevelSelectOverlay(): void {
    ...
    LEVELS.forEach((lv, i) => {
      ...
      if (unlocked) {
        ...
        btn.on("pointerout", () =>
          btn.setStyle({ color: "#e0e0e0", backgroundColor: "#252530" }),
        );
        btn.on("pointerdown", () => {
    ...
    closeBtn.on("pointerover", () =>
      closeBtn.setStyle({ color: "#ff6b35", backgroundColor: "#2a2a35" }),
    );
    closeBtn.on("pointerout", () =>
      closeBtn.setStyle({ color: "#e0e0e0", backgroundColor: "#1a1a25" }),
    );
  ...
  private createSmallButton(
    ...
    const btn = createUIText(this, x, y, label, {
      ...
      .setInteractive({ useHandCursor: true });
    btn.on("pointerover", () =>
      btn.setStyle({ color: "#ffffff", backgroundColor: "#353555" }),
    );
    btn.on("pointerout", () =>
      btn.setStyle({ color: "#e0e0e0", backgroundColor: "#252530" }),
    );
